...
#
# rebuild.tcl: Tcl script for re-creating project 'prj'
#
# Generated by Vivado on Fri Mar 24 17:52:43 CET 2023
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/prj.srcs/sources_1/imports/design_1_wrapper.v"]"\
  ]
  foreach ifile $files {
...
set_property -name "platform.name" -value "zed" -objects $obj
...
set_property -name "pfm_name" -value "xilinx:zedboard:zed:0.1" -objects $file_obj
...
set obj [get_runs impl_1]
set_property -name "auto_rqs.directory" -value "/scratch/prasadar/docs/courses/socdaml/vitis_zed_hw_platform/project_1/project_1.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/scratch/prasadar/docs/courses/socdaml/vitis_zed_hw_platform/project_1/project_1.srcs/utils_1/imports/impl_1" -objects $obj
