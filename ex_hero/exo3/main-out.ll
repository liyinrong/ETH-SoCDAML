...
for.cond19.preheader:                             ; preds = %for.cond.cleanup22, %for.cond19.preheader.preheader
  ...
  br i1 %cmp2084, label %for.body23.preheader, label %for.cond.cleanup22

for.body23.preheader:                             ; preds = %for.cond19.preheader
  br label %for.body23

for.cond30.preheader:                             ; preds = %for.cond.cleanup22
  %.lcssa4 = phi i32 [ %22, %for.cond.cleanup22 ]
  %.lcssa3 = phi i32 [ %23, %for.cond.cleanup22 ]
  %cmp3189 = icmp sgt i32 %.lcssa3, 0
  br i1 %cmp3189, label %for.body34.preheader, label %for.cond42.preheader

for.body34.preheader:                             ; preds = %for.cond30.preheader
  br label %for.body34

for.cond.cleanup22.loopexit:                      ; preds = %for.body23
  %.lcssa2 = phi i32 [ %25, %for.body23 ]
...
for.cond.cleanup22:                               ; preds = %for.cond.cleanup22.loopexit, %for.cond19.preheader
  ...
  %23 = phi i32 [ %.lcssa2, %for.cond.cleanup22.loopexit ], [ %21, %for.cond19.preheader ]
...
for.body23:                                       ; preds = %for.body23.preheader, %for.body23
  %24 = phi i32 [ %25, %for.body23 ], [ %21, %for.body23.preheader ]
  %j.085 = phi i32 [ %inc, %for.body23 ], [ 0, %for.body23.preheader ]
...
for.cond42.preheader:                             ; preds = %for.cond42.preheader.loopexit, %for.cond30.preheader
  %26 = phi i32 [ %.lcssa4, %for.cond30.preheader ], [ %.pre125, %for.cond42.preheader.loopexit ]
  %.lcssa = phi i32 [ %.lcssa3, %for.cond30.preheader ], [ %.lcssa1, %for.cond42.preheader.loopexit ]
...
for.body34:                                       ; preds = %for.body34.preheader, %for.body34
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body34 ], [ 0, %for.body34.preheader ]
...
for.cond77.preheader:                             ; preds = %for.cond.cleanup80, %for.cond77.preheader.lr.ph
...
for.cond.cleanup80.loopexit:                      ; preds = %for.body81
  %add89.lcssa = phi i32 [ %add89, %for.body81 ]
  br label %for.cond.cleanup80

for.cond.cleanup80:                               ; preds = %for.cond.cleanup80.loopexit, %for.cond77.preheader
  %val.0.lcssa = phi i32 [ 0, %for.cond77.preheader ], [ %add89.lcssa, %for.cond.cleanup80.loopexit ]
  ...
  br i1 %exitcond117.not, label %for.body103.preheader, label %for.cond77.preheader, !llvm.loop !20

for.body103.preheader:                            ; preds = %for.cond.cleanup80
...
for.body81:                                       ; preds = %for.body81, %for.body81.lr.ph
  ...
  br i1 %exitcond.not, label %for.cond.cleanup80.loopexit, label %for.body81, !llvm.loop !21

for.cond.cleanup102.loopexit:                     ; preds = %for.inc115
  br label %for.cond.cleanup102

for.cond.cleanup102:                              ; preds = %for.cond.cleanup102.loopexit, %omp_offload.cont69
...
for.body103:                                      ; preds = %for.body103.preheader, %for.inc115
  %68 = phi i32 [ %72, %for.inc115 ], [ %60, %for.body103.preheader ]
  %indvars.iv118 = phi i64 [ %indvars.iv.next119, %for.inc115 ], [ 0, %for.body103.preheader ]
...
for.inc115:                                       ; preds = %if.then, %for.body103
  %72 = phi i32 [ %68, %for.body103 ], [ %.pre126, %if.then ]
  %indvars.iv.next119 = add nuw nsw i64 %indvars.iv118, 1
  %73 = sext i32 %72 to i64
  %cmp100 = icmp slt i64 %indvars.iv.next119, %73
  br i1 %cmp100, label %for.body103, label %for.cond.cleanup102.loopexit, !llvm.loop !24
}
...
@.omp_offloading.entry_name = internal unnamed_addr constant [38 x i8] c"__omp_offloading_801_12c075c_main_l30\00"
@.omp_offloading.entry.__omp_offloading_801_12c075c_main_l30 = weak local_unnamed_addr constant %struct.__tgt_offload_entry { i8* bitcast (void (i64)* @__omp_offloading_801_12c075c_main_l30 to i8*), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.omp_offloading.entry_name, i32 0, i32 0), i32 0, i32 0, i32 0 }, section "omp_offloading_entries", align 1
@.omp_offloading.entry_name.2 = internal unnamed_addr constant [38 x i8] c"__omp_offloading_801_12c075c_main_l64\00"
@.omp_offloading.entry.__omp_offloading_801_12c075c_main_l64 = weak local_unnamed_addr constant %struct.__tgt_offload_entry { i8* bitcast (void (i64)* @__omp_offloading_801_12c075c_main_l64 to i8*), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.omp_offloading.entry_name.2, i32 0, i32 0), i32 0, i32 0, i32 0 }, section "omp_offloading_entries", align 1
...
define weak void @__wrapped_omp__omp_offloading_801_12c075c_main_l30() #0 {
entry:
...
; Function Attrs: alwaysinline convergent norecurse nounwind
define weak void @__wrapped_omp__omp_offloading_801_12c075c_main_l64(i32* noundef %C_phys, i32* noundef %D_phys, i32* noundef %E_phys, i32* noundef %width, i32* noundef %height) #0 {
entry:
...
dev_matvec.internalized.exit:                     ; preds = %for.cond.cleanup.i, %if.then22.i.i, %if.then.i.i, %entry
...
for.body:                                         ; preds = %if.end45, %for.body.lr.ph
...
dev_dma_memcpy.exit99:                            ; preds = %if.end.i98, %if.then22.i.i96, %if.then.i.i92
...
omp_exit:                                         ; preds = %for.cond.cleanup, %if.then22.i, %if.then.i, %entry
  ret void
}
...
for.cond.preheader:                               ; preds = %entry
  ...
  br i1 %cmp115.not, label %for.cond.cleanup, label %for.body.preheader
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %for.cond.preheader
  %val.0.lcssa = phi i32 [ 0, %for.cond.preheader ], [ %add5.lcssa, %for.cond.cleanup.loopexit ]
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %j.017 = phi i32 [ %inc, %for.body ], [ 0, %for.body.preheader ]
  %val.016 = phi i32 [ %add5, %for.body ], [ 0, %for.body.preheader ]
  ...
  br i1 %cmp1, label %for.body, label %for.cond.cleanup.loopexit, !llvm.loop !28

end:                                              ; preds = %for.cond.cleanup, %entry
  ret void
}
...
define weak void @__omp_offloading_801_12c075c_main_l30(i64 %0) {
entry:
  call void asm sideeffect "nop", ""() #7, !srcloc !8
  ret void
}

define weak void @__omp_offloading_801_12c075c_main_l64(i64 %0) {
entry:
  %x_out_phys.addr.i.i = alloca i32, align 4
  %n.addr.i.i = alloca i32, align 4
  %x_l1.i.i = alloca i32*, align 4
  %w_row_l1_comp.i.i = alloca i32*, align 4
  %I.i.i = alloca i32, align 4
  %rows_todo.i.i = alloca i32, align 4
  %_C_phys.i = alloca i32, align 4
  %_D_phys.i = alloca i32, align 4
  %_E_phys.i = alloca i32, align 4
  %_width.i = alloca i32, align 4
  ...
  %16 = getelementptr i64, i64 addrspace(1)* %1, i64 4
  %17 = ptrtoint i64 addrspace(1)* %16 to i64
  %18 = call i32 @hero_load_uint32(i64 %17)
  %19 = inttoptr i32 %18 to i32*
  %_C_phys.0._C_phys.0._C_phys.0..sroa_cast.i = bitcast i32* %_C_phys.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %_C_phys.0._C_phys.0._C_phys.0..sroa_cast.i) #5
  %20 = load i32, i32* %3, align 4, !tbaa !9
  store volatile i32 %20, i32* %_C_phys.i, align 4, !tbaa !9
  %_D_phys.0._D_phys.0._D_phys.0..sroa_cast.i = bitcast i32* %_D_phys.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %_D_phys.0._D_phys.0._D_phys.0..sroa_cast.i) #5
  %21 = load i32, i32* %7, align 4, !tbaa !9
  store volatile i32 %21, i32* %_D_phys.i, align 4, !tbaa !9
  %_E_phys.0._E_phys.0._E_phys.0..sroa_cast.i = bitcast i32* %_E_phys.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %_E_phys.0._E_phys.0._E_phys.0..sroa_cast.i) #5
  %22 = load i32, i32* %11, align 4, !tbaa !9
  store volatile i32 %22, i32* %_E_phys.i, align 4, !tbaa !9
  %_width.0._width.0._width.0..sroa_cast.i = bitcast i32* %_width.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %_width.0._width.0._width.0..sroa_cast.i) #5
  %23 = load i32, i32* %15, align 4, !tbaa !9
  store volatile i32 %23, i32* %_width.i, align 4, !tbaa !9
  %_height.0._height.0._height.0..sroa_cast.i = bitcast i32* %_height.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %_height.0._height.0._height.0..sroa_cast.i) #5
  %24 = load i32, i32* %19, align 4, !tbaa !9
  store volatile i32 %24, i32* %_height.i, align 4, !tbaa !9
  %_E_phys.0._E_phys.0._E_phys.0..i = load volatile i32, i32* %_E_phys.i, align 4, !tbaa !9
  %_C_phys.0._C_phys.0._C_phys.0..i = load volatile i32, i32* %_C_phys.i, align 4, !tbaa !9
  %_D_phys.0._D_phys.0._D_phys.0..i = load volatile i32, i32* %_D_phys.i, align 4, !tbaa !9
  ...
  %25 = bitcast i32* %x_out_phys.addr.i.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %25) #5
  %26 = bitcast i32* %n.addr.i.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %26) #5
  %27 = bitcast i32** %x_l1.i.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %27) #5
  %28 = bitcast i32** %w_row_l1_comp.i.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %28) #5
  store i32 %22, i32* %x_out_phys.addr.i.i, align 4, !tbaa !9
  store i32 %23, i32* %n.addr.i.i, align 4, !tbaa !9
  %tobool.i.i = icmp ne i32 %23, 0
  %tobool1.i.i = icmp ne i32 %24, 0
  %or.cond.i.i = and i1 %tobool.i.i, %tobool1.i.i
  %tobool3.i.i = icmp ne i32 %22, 0
  %or.cond47.i.i = and i1 %tobool3.i.i, %or.cond.i.i
  %tobool5.i.i = icmp ne i32 %21, 0
  %or.cond48.i.i = and i1 %tobool5.i.i, %or.cond47.i.i
  %tobool7.i.i = icmp ne i32 %20, 0
  %or.cond49.i.i = and i1 %tobool7.i.i, %or.cond48.i.i
  br i1 %or.cond49.i.i, label %if.end.i.i, label %__wrapped_omp__omp_offloading_801_12c075c_main_l64.exit

if.end.i.i:                                       ; preds = %entry
  %29 = inttoptr i32 %22 to i8*
  %30 = inttoptr i32 %21 to i8*
  %mul.i.i = mul i32 %24, %23
  %cmp.i.i.i = icmp ugt i8* %29, inttoptr (i32 268435456 to i8*)
  %cmp1.i.i.i = icmp ult i8* %29, inttoptr (i32 269484031 to i8*)
  %or.cond.i.i.i = and i1 %cmp.i.i.i, %cmp1.i.i.i
  br i1 %or.cond.i.i.i, label %lor.lhs.false9.i.i.i, label %lor.lhs.false.i.i.i

lor.lhs.false.i.i.i:                              ; preds = %if.end.i.i
  %cmp2.i.i.i = icmp ugt i8* %29, inttoptr (i32 1895825408 to i8*)
  %cmp4.i.i.i = icmp ult i8* %29, inttoptr (i32 1912602623 to i8*)
  %or.cond27.i.i.i = and i1 %cmp2.i.i.i, %cmp4.i.i.i
  br i1 %or.cond27.i.i.i, label %lor.lhs.false9.i.i.i, label %lor.lhs.false5.i.i.i

lor.lhs.false5.i.i.i:                             ; preds = %lor.lhs.false.i.i.i
  %cmp6.i.i.i = icmp ugt i8* %29, inttoptr (i32 -1073741824 to i8*)
  %cmp8.i.i.i = icmp ne i8* %29, inttoptr (i32 -1 to i8*)
  %or.cond29.i.i.i = and i1 %cmp6.i.i.i, %cmp8.i.i.i
  br i1 %or.cond29.i.i.i, label %lor.lhs.false9.i.i.i, label %if.then.i.i.i

lor.lhs.false9.i.i.i:                             ; preds = %lor.lhs.false5.i.i.i, %lor.lhs.false.i.i.i, %if.end.i.i
  %cmp10.i.i.i = icmp ugt i8* %30, inttoptr (i32 268435456 to i8*)
  %cmp12.i.i.i = icmp ult i8* %30, inttoptr (i32 269484031 to i8*)
  %or.cond31.i.i.i = and i1 %cmp10.i.i.i, %cmp12.i.i.i
  br i1 %or.cond31.i.i.i, label %if.end.i.i.i, label %lor.lhs.false13.i.i.i

lor.lhs.false13.i.i.i:                            ; preds = %lor.lhs.false9.i.i.i
  %cmp14.i.i.i = icmp ugt i8* %30, inttoptr (i32 1895825408 to i8*)
  %cmp16.i.i.i = icmp ult i8* %30, inttoptr (i32 1912602623 to i8*)
  %or.cond33.i.i.i = and i1 %cmp14.i.i.i, %cmp16.i.i.i
  br i1 %or.cond33.i.i.i, label %if.end.i.i.i, label %lor.lhs.false17.i.i.i

lor.lhs.false17.i.i.i:                            ; preds = %lor.lhs.false13.i.i.i
  %cmp18.i.i.i = icmp ugt i8* %30, inttoptr (i32 -1073741824 to i8*)
  %cmp20.i.i.i = icmp ne i8* %30, inttoptr (i32 -1 to i8*)
  %or.cond35.i.i.i = and i1 %cmp18.i.i.i, %cmp20.i.i.i
  br i1 %or.cond35.i.i.i, label %if.end.i.i.i, label %if.then.i.i.i

if.then.i.i.i:                                    ; preds = %lor.lhs.false17.i.i.i, %lor.lhs.false5.i.i.i
  %call.i.i.i = call i32 bitcast (i32 (...)* @snrt_printf to i32 (i8*, i8*, i8*)*)(i8* noundef getelementptr inbounds ([61 x i8], [61 x i8]* @.str, i32 0, i32 0), i8* noundef nonnull %29, i8* noundef nonnull %30) #7
  br label %__wrapped_omp__omp_offloading_801_12c075c_main_l64.exit

if.end.i.i.i:                                     ; preds = %lor.lhs.false17.i.i.i, %lor.lhs.false13.i.i.i, %lor.lhs.false9.i.i.i
  %cmp21.i.i.i = icmp ugt i32 %mul.i.i, 1048576
  br i1 %cmp21.i.i.i, label %if.then22.i.i.i, label %if.end10.i.i

if.then22.i.i.i:                                  ; preds = %if.end.i.i.i
  %call23.i.i.i = call i32 bitcast (i32 (...)* @snrt_printf to i32 (i8*, i32)*)(i8* noundef getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i32 0, i32 0), i32 noundef %mul.i.i) #7
  br label %__wrapped_omp__omp_offloading_801_12c075c_main_l64.exit

if.end10.i.i:                                     ; preds = %if.end.i.i.i
  %mul11.i.i = shl i32 %23, 2
  %call12.i.i = call i32 bitcast (i32 (...)* @snrt_l1alloc to i32 (i32)*)(i32 noundef %mul11.i.i) #7
  %31 = inttoptr i32 %call12.i.i to i32*
  store i32* %31, i32** %x_l1.i.i, align 4, !tbaa !13
  %mul14.i.i = shl i32 %23, 5
  %call15.i.i = call i32 bitcast (i32 (...)* @snrt_l1alloc to i32 (i32)*)(i32 noundef %mul14.i.i) #7
  %32 = inttoptr i32 %call15.i.i to i32*
  %call18.i.i = call i32 bitcast (i32 (...)* @snrt_l1alloc to i32 (i32)*)(i32 noundef %mul14.i.i) #7
  %33 = inttoptr i32 %call18.i.i to i32*
  %34 = inttoptr i32 %call12.i.i to i8*
  %cmp.i.i.i.i = icmp ugt i8* %34, inttoptr (i32 268435456 to i8*)
  %cmp1.i.i.i.i = icmp ult i8* %34, inttoptr (i32 269484031 to i8*)
...
lor.lhs.false.i.i.i.i:                            ; preds = %if.end10.i.i
  %cmp2.i.i.i.i = icmp ugt i8* %34, inttoptr (i32 1895825408 to i8*)
  %cmp4.i.i.i.i = icmp ult i8* %34, inttoptr (i32 1912602623 to i8*)
...
lor.lhs.false5.i.i.i.i:                           ; preds = %lor.lhs.false.i.i.i.i
  %cmp6.i.i.i.i = icmp ugt i8* %34, inttoptr (i32 -1073741824 to i8*)
  %cmp8.i.i.i.i = icmp ne i8* %34, inttoptr (i32 -1 to i8*)
...
lor.lhs.false9.i.i.i.i:                           ; preds = %lor.lhs.false5.i.i.i.i, %lor.lhs.false.i.i.i.i, %if.end10.i.i
  br i1 %or.cond31.i.i.i, label %if.end.i.i.i.i, label %lor.lhs.false13.i.i.i.i

lor.lhs.false13.i.i.i.i:                          ; preds = %lor.lhs.false9.i.i.i.i
  %cmp14.i.i.i.i = icmp ugt i8* %30, inttoptr (i32 1895825408 to i8*)
  %cmp16.i.i.i.i = icmp ult i8* %30, inttoptr (i32 1912602623 to i8*)
...
lor.lhs.false17.i.i.i.i:                          ; preds = %lor.lhs.false13.i.i.i.i
  %cmp18.i.i.i.i = icmp ugt i8* %30, inttoptr (i32 -1073741824 to i8*)
  %cmp20.i.i.i.i = icmp ne i8* %30, inttoptr (i32 -1 to i8*)
...
if.then.i.i.i.i:                                  ; preds = %lor.lhs.false17.i.i.i.i, %lor.lhs.false5.i.i.i.i
  %call.i.i.i.i = call i32 bitcast (i32 (...)* @snrt_printf to i32 (i8*, i8*, i8*)*)(i8* noundef getelementptr inbounds ([61 x i8], [61 x i8]* @.str, i32 0, i32 0), i8* noundef %34, i8* noundef nonnull %30) #7
...
if.then22.i.i.i.i:                                ; preds = %if.end.i.i.i.i
  %call23.i.i.i.i = call i32 bitcast (i32 (...)* @snrt_printf to i32 (i8*, i32)*)(i8* noundef getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i32 0, i32 0), i32 noundef %mul11.i.i) #7
  br label %for.body.lr.ph.i.i

if.end.i3.i.i:                                    ; preds = %if.end.i.i.i.i
  %call1.i.i.i = call i32 bitcast (i32 (...)* @dm_memcpy_async to i32 (i8*, i8*, i32)*)(i8* noundef %34, i8* noundef nonnull %30, i32 noundef %mul11.i.i) #7
  br label %for.body.lr.ph.i.i

for.body.lr.ph.i.i:                               ; preds = %if.end.i3.i.i, %if.then22.i.i.i.i, %if.then.i.i.i.i
  %call20.i.i = call i32 bitcast (i32 (...)* @dm_wait to i32 ()*)() #7
  %35 = bitcast i32* %I.i.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %35) #5
  %36 = bitcast i32* %rows_todo.i.i to i8*
  store i32 0, i32* %I.i.i, align 4, !tbaa !9
  %37 = inttoptr i32 %call15.i.i to i8*
  %38 = inttoptr i32 %20 to i8*
  %cmp.i.i4.i.i = icmp ugt i8* %37, inttoptr (i32 268435456 to i8*)
  %cmp1.i.i5.i.i = icmp ult i8* %37, inttoptr (i32 269484031 to i8*)
  %or.cond.i.i6.i.i = and i1 %cmp.i.i4.i.i, %cmp1.i.i5.i.i
  %cmp2.i.i7.i.i = icmp ugt i8* %37, inttoptr (i32 1895825408 to i8*)
  %cmp4.i.i8.i.i = icmp ult i8* %37, inttoptr (i32 1912602623 to i8*)
  %or.cond27.i.i9.i.i = and i1 %cmp2.i.i7.i.i, %cmp4.i.i8.i.i
  %cmp6.i.i11.i.i = icmp ugt i8* %37, inttoptr (i32 -1073741824 to i8*)
  %cmp8.i.i12.i.i = icmp ne i8* %37, inttoptr (i32 -1 to i8*)
  %or.cond29.i.i13.i.i = and i1 %cmp6.i.i11.i.i, %cmp8.i.i12.i.i
  %cmp10.i.i15.i.i = icmp ugt i8* %38, inttoptr (i32 268435456 to i8*)
  %cmp12.i.i16.i.i = icmp ult i8* %38, inttoptr (i32 269484031 to i8*)
  %or.cond31.i.i17.i.i = and i1 %cmp10.i.i15.i.i, %cmp12.i.i16.i.i
  %cmp14.i.i19.i.i = icmp ugt i8* %38, inttoptr (i32 1895825408 to i8*)
  %cmp16.i.i20.i.i = icmp ult i8* %38, inttoptr (i32 1912602623 to i8*)
  %or.cond33.i.i21.i.i = and i1 %cmp14.i.i19.i.i, %cmp16.i.i20.i.i
  %cmp18.i.i23.i.i = icmp ugt i8* %38, inttoptr (i32 -1073741824 to i8*)
  %cmp20.i.i24.i.i = icmp ne i8* %38, inttoptr (i32 -1 to i8*)
  %or.cond35.i.i25.i.i = and i1 %cmp18.i.i23.i.i, %cmp20.i.i24.i.i
  %brmerge.i.i = or i1 %or.cond.i.i6.i.i, %or.cond27.i.i9.i.i
  %brmerge73.i.i = select i1 %brmerge.i.i, i1 true, i1 %or.cond29.i.i13.i.i
  %brmerge74.i.i = or i1 %or.cond31.i.i17.i.i, %or.cond33.i.i21.i.i
  %brmerge75.i.i = or i1 %or.cond35.i.i25.i.i, %brmerge74.i.i
  %or.cond76.i.i = and i1 %brmerge75.i.i, %brmerge73.i.i
  br label %for.body.i.i

for.cond.cleanup.i.i:                             ; preds = %if.end45.i.i
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %35) #5
  br label %__wrapped_omp__omp_offloading_801_12c075c_main_l64.exit

for.body.i.i:                                     ; preds = %if.end45.i.i, %for.body.lr.ph.i.i
  %w_row_l1_copy.072.i.i = phi i32* [ undef, %for.body.lr.ph.i.i ], [ %47, %if.end45.i.i ]
  %storemerge71.i.i = phi i32 [ 0, %for.body.lr.ph.i.i ], [ %add46.i.i, %if.end45.i.i ]
  %sub.i.i = sub i32 %24, %storemerge71.i.i
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %36) #5
  %39 = call i32 @llvm.smin.i32(i32 %sub.i.i, i32 8) #5, !range !15
  store i32 %39, i32* %rows_todo.i.i, align 4, !tbaa !9
  %cmp22.i.i = icmp eq i32 %storemerge71.i.i, 0
  br i1 %cmp22.i.i, label %if.then23.i.i, label %if.end28.i.i

if.then23.i.i:                                    ; preds = %for.body.i.i
  %40 = load i32, i32* %n.addr.i.i, align 4, !tbaa !9
  %mul26.i.i = shl i32 %39, 2
  %mul27.i.i = mul i32 %40, %mul26.i.i
  br i1 %or.cond76.i.i, label %if.end.i.i30.i.i, label %if.then.i.i28.i.i

if.then.i.i28.i.i:                                ; preds = %if.then23.i.i
  %call.i.i27.i.i = call i32 bitcast (i32 (...)* @snrt_printf to i32 (i8*, i8*, i8*)*)(i8* noundef getelementptr inbounds ([61 x i8], [61 x i8]* @.str, i32 0, i32 0), i8* noundef %37, i8* noundef nonnull %38) #7
  br label %dev_dma_memcpy.internalized.exit35.i.i

if.end.i.i30.i.i:                                 ; preds = %if.then23.i.i
  %cmp21.i.i29.i.i = icmp ugt i32 %mul27.i.i, 1048576
  br i1 %cmp21.i.i29.i.i, label %if.then22.i.i32.i.i, label %if.end.i34.i.i

if.then22.i.i32.i.i:                              ; preds = %if.end.i.i30.i.i
  %call23.i.i31.i.i = call i32 bitcast (i32 (...)* @snrt_printf to i32 (i8*, i32)*)(i8* noundef getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i32 0, i32 0), i32 noundef %mul27.i.i) #7
  br label %dev_dma_memcpy.internalized.exit35.i.i

if.end.i34.i.i:                                   ; preds = %if.end.i.i30.i.i
  %call1.i33.i.i = call i32 bitcast (i32 (...)* @dm_memcpy_async to i32 (i8*, i8*, i32)*)(i8* noundef %37, i8* noundef nonnull %38, i32 noundef %mul27.i.i) #7
  br label %dev_dma_memcpy.internalized.exit35.i.i

dev_dma_memcpy.internalized.exit35.i.i:           ; preds = %if.end.i34.i.i, %if.then22.i.i32.i.i, %if.then.i.i28.i.i
  store i32* %32, i32** %w_row_l1_comp.i.i, align 4, !tbaa !13
  br label %if.end28.i.i

if.end28.i.i:                                     ; preds = %dev_dma_memcpy.internalized.exit35.i.i, %for.body.i.i
  %w_row_l1_copy.1.i.i = phi i32* [ %33, %dev_dma_memcpy.internalized.exit35.i.i ], [ %w_row_l1_copy.072.i.i, %for.body.i.i ]
  %call29.i.i = call i32 bitcast (i32 (...)* @dm_wait to i32 ()*)() #7
  %41 = call i32 @llvm.smin.i32(i32 %sub.i.i, i32 16) #5, !range !16
  %cmp37.i.i = icmp sgt i32 %41, 8
  br i1 %cmp37.i.i, label %if.then38.i.i, label %if.end45.i.i

if.then38.i.i:                                    ; preds = %if.end28.i.i
  %42 = bitcast i32* %w_row_l1_copy.1.i.i to i8*
  %43 = load i32, i32* %n.addr.i.i, align 4, !tbaa !9
  %mul39.i.i = shl i32 %43, 2
  %44 = load i32, i32* %I.i.i, align 4, !tbaa !9
  %add40.i.i = add nsw i32 %44, 8
  %mul41.i.i = mul i32 %mul39.i.i, %add40.i.i
  %add42.i.i = add i32 %mul41.i.i, %20
  %45 = inttoptr i32 %add42.i.i to i8*
  %46 = shl nuw nsw i32 %41, 2
  %mul43.i.i = add nsw i32 %46, -32
  %mul44.i.i = mul i32 %43, %mul43.i.i
  %cmp.i.i36.i.i = icmp ugt i32* %w_row_l1_copy.1.i.i, inttoptr (i32 268435456 to i32*)
  %cmp1.i.i37.i.i = icmp ult i32* %w_row_l1_copy.1.i.i, inttoptr (i32 269484031 to i32*)
  %or.cond.i.i38.i.i = and i1 %cmp.i.i36.i.i, %cmp1.i.i37.i.i
  br i1 %or.cond.i.i38.i.i, label %lor.lhs.false9.i.i50.i.i, label %lor.lhs.false.i.i42.i.i

lor.lhs.false.i.i42.i.i:                          ; preds = %if.then38.i.i
  %cmp2.i.i39.i.i = icmp ugt i32* %w_row_l1_copy.1.i.i, inttoptr (i32 1895825408 to i32*)
  %cmp4.i.i40.i.i = icmp ult i32* %w_row_l1_copy.1.i.i, inttoptr (i32 1912602623 to i32*)
  %or.cond27.i.i41.i.i = and i1 %cmp2.i.i39.i.i, %cmp4.i.i40.i.i
  br i1 %or.cond27.i.i41.i.i, label %lor.lhs.false9.i.i50.i.i, label %lor.lhs.false5.i.i46.i.i

lor.lhs.false5.i.i46.i.i:                         ; preds = %lor.lhs.false.i.i42.i.i
  %cmp6.i.i43.i.i = icmp ugt i32* %w_row_l1_copy.1.i.i, inttoptr (i32 -1073741824 to i32*)
  %cmp8.i.i44.i.i = icmp ne i32* %w_row_l1_copy.1.i.i, inttoptr (i32 -1 to i32*)
  %or.cond29.i.i45.i.i = and i1 %cmp6.i.i43.i.i, %cmp8.i.i44.i.i
  br i1 %or.cond29.i.i45.i.i, label %lor.lhs.false9.i.i50.i.i, label %if.then.i.i60.i.i

lor.lhs.false9.i.i50.i.i:                         ; preds = %lor.lhs.false5.i.i46.i.i, %lor.lhs.false.i.i42.i.i, %if.then38.i.i
  %cmp10.i.i47.i.i = icmp ugt i8* %45, inttoptr (i32 268435456 to i8*)
  %cmp12.i.i48.i.i = icmp ult i8* %45, inttoptr (i32 269484031 to i8*)
  %or.cond31.i.i49.i.i = and i1 %cmp10.i.i47.i.i, %cmp12.i.i48.i.i
  br i1 %or.cond31.i.i49.i.i, label %if.end.i.i62.i.i, label %lor.lhs.false13.i.i54.i.i

lor.lhs.false13.i.i54.i.i:                        ; preds = %lor.lhs.false9.i.i50.i.i
  %cmp14.i.i51.i.i = icmp ugt i8* %45, inttoptr (i32 1895825408 to i8*)
  %cmp16.i.i52.i.i = icmp ult i8* %45, inttoptr (i32 1912602623 to i8*)
  %or.cond33.i.i53.i.i = and i1 %cmp14.i.i51.i.i, %cmp16.i.i52.i.i
  br i1 %or.cond33.i.i53.i.i, label %if.end.i.i62.i.i, label %lor.lhs.false17.i.i58.i.i

lor.lhs.false17.i.i58.i.i:                        ; preds = %lor.lhs.false13.i.i54.i.i
  %cmp18.i.i55.i.i = icmp ugt i8* %45, inttoptr (i32 -1073741824 to i8*)
  %cmp20.i.i56.i.i = icmp ne i8* %45, inttoptr (i32 -1 to i8*)
  %or.cond35.i.i57.i.i = and i1 %cmp18.i.i55.i.i, %cmp20.i.i56.i.i
  br i1 %or.cond35.i.i57.i.i, label %if.end.i.i62.i.i, label %if.then.i.i60.i.i

if.then.i.i60.i.i:                                ; preds = %lor.lhs.false17.i.i58.i.i, %lor.lhs.false5.i.i46.i.i
  %call.i.i59.i.i = call i32 bitcast (i32 (...)* @snrt_printf to i32 (i8*, i8*, i8*)*)(i8* noundef getelementptr inbounds ([61 x i8], [61 x i8]* @.str, i32 0, i32 0), i8* noundef %42, i8* noundef %45) #7
  br label %if.end45.i.i

if.end.i.i62.i.i:                                 ; preds = %lor.lhs.false17.i.i58.i.i, %lor.lhs.false13.i.i54.i.i, %lor.lhs.false9.i.i50.i.i
  %cmp21.i.i61.i.i = icmp ugt i32 %mul44.i.i, 1048576
  br i1 %cmp21.i.i61.i.i, label %if.then22.i.i64.i.i, label %if.end.i66.i.i

if.then22.i.i64.i.i:                              ; preds = %if.end.i.i62.i.i
  %call23.i.i63.i.i = call i32 bitcast (i32 (...)* @snrt_printf to i32 (i8*, i32)*)(i8* noundef getelementptr inbounds ([43 x i8], [43 x i8]* @.str.1, i32 0, i32 0), i32 noundef %mul44.i.i) #7
  br label %if.end45.i.i

if.end.i66.i.i:                                   ; preds = %if.end.i.i62.i.i
  %call1.i65.i.i = call i32 bitcast (i32 (...)* @dm_memcpy_async to i32 (i8*, i8*, i32)*)(i8* noundef %42, i8* noundef %45, i32 noundef %mul44.i.i) #7
  br label %if.end45.i.i

if.end45.i.i:                                     ; preds = %if.end.i66.i.i, %if.then22.i.i64.i.i, %if.then.i.i60.i.i, %if.end28.i.i
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @1, i32 6, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i32*, i32**, i32**, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %rows_todo.i.i, i32* nonnull %n.addr.i.i, i32** nonnull %x_l1.i.i, i32** nonnull %w_row_l1_comp.i.i, i32* nonnull %x_out_phys.addr.i.i, i32* nonnull %I.i.i) #5
  %47 = load i32*, i32** %w_row_l1_comp.i.i, align 4, !tbaa !13
  store i32* %w_row_l1_copy.1.i.i, i32** %w_row_l1_comp.i.i, align 4, !tbaa !13
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %36) #5
  %48 = load i32, i32* %I.i.i, align 4, !tbaa !9
  %add46.i.i = add nsw i32 %48, 8
  store i32 %add46.i.i, i32* %I.i.i, align 4, !tbaa !9
  %cmp.i.i = icmp ult i32 %add46.i.i, %24
  br i1 %cmp.i.i, label %for.body.i.i, label %for.cond.cleanup.i.i, !llvm.loop !17

__wrapped_omp__omp_offloading_801_12c075c_main_l64.exit: ; preds = %for.cond.cleanup.i.i, %if.then22.i.i.i, %if.then.i.i.i, %entry
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %_height.0._height.0._height.0..sroa_cast.i) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %_width.0._width.0._width.0..sroa_cast.i) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %_E_phys.0._E_phys.0._E_phys.0..sroa_cast.i) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %_D_phys.0._D_phys.0._D_phys.0..sroa_cast.i) #5
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %_C_phys.0._C_phys.0._C_phys.0..sroa_cast.i) #5
  ret void
}
