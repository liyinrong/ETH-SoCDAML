/*
-- File : tzscale_bitfield.h
--
-- Contents : Software bitfield extraction rules for the tzscale processor.
--
...
#ifndef _tzscale_bitfield_h
#define _tzscale_bitfield_h
