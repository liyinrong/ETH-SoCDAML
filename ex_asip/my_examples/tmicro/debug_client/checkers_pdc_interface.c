...
void Checkers_pdc_interface::get_trace(std::vector<Trace_entry>& buf)
{
    cmd.get_trace(buf);
}

void Checkers_pdc_interface::config_trace(long long value)
{
    cmd.config_trace(value);
}
