...
// module reg_SRb : reg_SRb
module reg_SRb
  // synopsys translate_off
  #(parameter reg_log = 1'b1,
    parameter reg_log_name = "SRb"
  )
  // synopsys translate_on
  ( input            clock,
    input      [1:0] bin_selector_E1,
    input      [2:0] __pm_read_w_SR_el4_in, // uint3
    input      [2:0] dm_read_rec5_in, // uint3
    input      [2:0] wbus_rec12_in, // uint3
    output reg [2:0] __pm_write_r_SR_el4_out, // uint3
    output reg [2:0] dm_write_rec5_out, // uint3
    output reg [2:0] wbus_rec5_out // uint3
  );


  reg [2:0] reg_val;

  reg [2:0] reg_val_next;
  ...
  always @ (*)
  begin : p_read_reg_SRb

    // __pm_write_r_SR_el4_out = 0;
    // dm_write_rec5_out = 0;
    // wbus_rec5_out = 0;

    // (wbus_rd_SR_E1_t4)
    // [move.n:48][move.n:96][control.n:225][dma.n:51](tmicro.n:132)
    wbus_rec5_out = reg_val;

    // (dm_write_rd_SR_E1_t4)
    // [load_store.n:57][load_store.n:99](tmicro.n:132)
    dm_write_rec5_out = reg_val;

    // (__pm_write_r_SR_rd_SR_E1_t4)
    // [load_store.n:130](tmicro.n:132)
    __pm_write_r_SR_el4_out = reg_val;

  end

  always @ (*)
  begin : p_write_combin_reg_SRb
    ...
    case (bin_selector_E1)
      2'b01 : // (SR_wr_wbus_E1_t4)
      begin
        // [move.n:48][move.n:55][move.n:62][move.n:106][control.n:238][dma.n:70](tmicro.n:132)
        reg_write_enab = 1'b1;
        reg_val_next = wbus_rec12_in;
      end
      2'b10 : // (SR_wr_dm_read_E1_t4)
      begin
        // [load_store.n:51][load_store.n:93](tmicro.n:132)
        reg_write_enab = 1'b1;
        reg_val_next = dm_read_rec5_in;
      end
      2'b11 : // (SR_wr___pm_read_w_SR_E1_t4)
      begin
        // [load_store.n:116](tmicro.n:132)
        reg_write_enab = 1'b1;
        reg_val_next = __pm_read_w_SR_el4_in;
      end
      default :
        ; // null
    endcase
