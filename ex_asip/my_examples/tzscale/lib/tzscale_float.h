/*
-- File : tzscale_float.h
--
-- Contents : Floating point application layer for the tzscale processor.
--
...
#ifndef _tzscale_float_h
#define _tzscale_float_h

// IEEE 754 single precision
class float  property( 32 bits, sign_magnitude,  8 exp_bits, llvm_emulated); 
 
// IEEE 754 double precision
class double property( 64 bits, sign_magnitude, 11 exp_bits, llvm_emulated); 
...
typedef tzscale_primitive::dint float64;
