...
// File: stack_DMb.c
// Stack frame 0 : memory DMb stack pointer SP
...
v2short stack_load_v2short_DMb() { volatile v2short o[M]; return o[N]; }
void stack_store_v2short_DMb(v2short a) { volatile v2short o[M]; o[N] = a; }
v2short stack_st_ld_v2short_DMb(v2short a) { volatile v2short o[M]; o[N] = a; return o[N]; }


} //extern "C"  (39 functions)
