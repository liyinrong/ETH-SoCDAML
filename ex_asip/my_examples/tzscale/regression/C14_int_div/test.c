...
void signed_div_const(STYPE a)
{
    ...
    STYPE c;
    chess_report(c = (a / (STYPE) 1) + 1 );
    chess_report(c = (a % (STYPE) 1) + 1);
    chess_report(c = (a / (STYPE) 2) + 1);
    chess_report(c = (a % (STYPE) 2) + 1);
    chess_report(c = (a / (STYPE) 3) + 1);
    chess_report(c = (a % (STYPE) 3) + 1);
    chess_report(c = (a / (STYPE) 7) + 1);
    chess_report(c = (a % (STYPE) 7) + 1);
    chess_report(c = (a / (STYPE) 8) + 1);
    chess_report(c = (a % (STYPE) 8) + 1);
    chess_report(c = (a / (STYPE)-1) + 1);
    chess_report(c = (a % (STYPE)-1) + 1);
    chess_report(c = (a / (STYPE)-2) + 1);
...
void unsigned_div_const(UTYPE a)
{
    ...
    UTYPE c;
    chess_report(c = (a / (UTYPE)1) + 1);
    chess_report(c = (a % (UTYPE)1) + 1);
    chess_report(c = (a / (UTYPE)2) + 1);
    chess_report(c = (a % (UTYPE)2) + 1);
    chess_report(c = (a / (UTYPE)3) + 1);
    chess_report(c = (a % (UTYPE)3) + 1);
    chess_report(c = (a / (UTYPE)7) + 1);
    chess_report(c = (a % (UTYPE)7) + 1);
    chess_report(c = (a / (UTYPE)8) + 1);
    chess_report(c = (a % (UTYPE)8) + 1);
}
