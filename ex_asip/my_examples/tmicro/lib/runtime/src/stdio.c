...
size_t fwrite(const void chess_storage(DM)* ptr, size_t size, size_t nmemb, FILE* stream)
{
    Hosted_clib_vars _hosted_clib_vars;
    // Pass arguments to host
    _hosted_clib_vars.stream_id = stream->stream;
    ...
    _hosted_clib_vars.str_arg1.mem = "DM";
    // Call fwrite on host
...
size_t fread(void chess_storage(DM)* ptr, size_t size, size_t nmemb, FILE* stream)
{
    Hosted_clib_vars _hosted_clib_vars;
    // Pass arguments to host
    _hosted_clib_vars.stream_id = stream->stream;
...
size_t fwrite_word(const void chess_storage(DM)* ptr, size_t size, size_t nword, int lsb_first, FILE* stream)
{
    Hosted_clib_vars _hosted_clib_vars;
    // Pass arguments to host
    _hosted_clib_vars.stream_id = stream->stream;
...
size_t fread_word(void chess_storage(DM)* ptr, size_t size, size_t nword, int lsb_first, FILE* stream)
{
    Hosted_clib_vars _hosted_clib_vars;
    // Pass arguments to host
    _hosted_clib_vars.stream_id = stream->stream;
