...
/* Definitions for driver FILT_BP_HW */
#define XPAR_XFILT_BP_HW_NUM_INSTANCES 1

/* Definitions for peripheral FILT_BP_HW_1 */
#define XPAR_FILT_BP_HW_1_DEVICE_ID 0
#define XPAR_FILT_BP_HW_1_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_FILT_BP_HW_1_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral FILT_BP_HW_1 */
#define XPAR_XFILT_BP_HW_0_DEVICE_ID XPAR_FILT_BP_HW_1_DEVICE_ID
#define XPAR_XFILT_BP_HW_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XFILT_BP_HW_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
