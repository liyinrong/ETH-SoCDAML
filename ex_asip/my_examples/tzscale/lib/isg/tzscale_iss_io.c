...
#endif
#ifdef checkers_[=getdesign_name=]_R8_15_si
# define chess_[=getdesign_name=]_R8_15_si checkers_[=getdesign_name=]_R8_15_si
#else
# define chess_[=getdesign_name=]_R8_15_si (-1)
#endif
...
int [=getdesign_name=]_read0_pad12(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    ...
    Checkers_storage* sti = uicore->core()->storinfo(si);
    if (!sti)
        return chkapi_errorsp->put(chkapi_ERR, "Illegal storage index ", "[=getdesign_name=]_read0_pad12");
    DataType vval = sti->vbit(0);
    int rt = chkapi_l_storage_get_vbit(uicore, sta, vval);
    val[0] = vval.as_signed().to_longlong();
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read value", "[=getdesign_name=]_read0_pad12");
...
int [=getdesign_name=]_write0_pad12(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    ...
    Checkers_storage* sti = uicore->core()->storinfo(si);
    if (!sti)
        return chkapi_errorsp->put(chkapi_ERR, "Illegal storage index ", "[=getdesign_name=]_write0_pad12");
    DataType vval = sti->vbit((int)tval[0]);
    int rt = chkapi_l_storage_put_vbit(uicore, sta, vval);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write value", "[=getdesign_name=]_write0_pad12");
    return chkapi_OK;
}
...
int [=getdesign_name=]_read1_record4(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record4");
    val[0] |= CHESS_MASKLL(fval[0], 1) << 0;
    // complete
    val[0] = CHESS_EXTENDLL(val[0],1);
    return chkapi_OK;
...
int [=getdesign_name=]_write1_record4(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record4");
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_read1_record5(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_read0_DMw_stat(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record5");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // component 1 : 32 bits at 32
    rt = [=getdesign_name=]_read0_DMw_stat(uicore, fval,1, si, addr + 4);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of record value", "[=getdesign_name=]_read1_record5");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_write1_record5(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_write0_DMw_stat(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record5");
    // component 1 : 32 bits at 32
    fval[0] = CHESS_EXTENDLL(tval[0] >> 32, 32);
    rt = [=getdesign_name=]_write0_DMw_stat(uicore, fval,1, si, addr + 4);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write component 1 of record value", "[=getdesign_name=]_write1_record5");
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_read1_record6(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    val[0] = 0;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record6");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // component 1 : 32 bits at 32
    rt = [=getdesign_name=]_read0(uicore, fval,1, si, addr + 1);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of record value", "[=getdesign_name=]_read1_record6");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // complete
    return chkapi_OK;
}

int [=getdesign_name=]_write1_record6(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    /*const*/ long long* tval = (long long*)val;
    long long fval[1] = {0};
    int rt;
    ...
    rt = [=getdesign_name=]_write0(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record6");
    // component 1 : 32 bits at 32
    fval[0] = CHESS_EXTENDLL(tval[0] >> 32, 32);
    rt = [=getdesign_name=]_write0(uicore, fval,1, si, addr + 1);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write component 1 of record value", "[=getdesign_name=]_write1_record6");
    // complete
    return chkapi_OK;
}
...
int [=getdesign_name=]_readstring0(Checkers_uicore* uicore, std::string& val, int si, int csz, AddressType addr)
{
    ...
    while (1) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read character from string", "tzscale_readstring0");
        if (!cval) break;
        val += (char)(cval & 0xff);
        addr += csz;
    }
...
int [=getdesign_name=]_writestring0(Checkers_uicore* uicore, std::string val, int si, int csz, AddressType addr, int term_zero)
{
    for (unsigned i = 0; i < val.length(); i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write character from string", "tzscale_writestring0");
        addr += csz;
    }
    if (term_zero) {
        long long cval = 0;
        int rt = [=getdesign_name=]_write0(uicore, &cval,1, si, addr);
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write terminating zero from string", "tzscale_writestring0");
    }
    return chkapi_OK;
}
...
{
    addr -= 8;
    int rt = [=getdesign_name=]_read1_record1(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_put_DMb___slonglong(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write1_record1(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_getalt_DMb___slonglong(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned value", "[=getdesign_name=]_getalt_DMb___slonglong");
...
int [=getdesign_name=]_getalt_DMb___ulonglong(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    rt = [=getdesign_name=]_read0_DMw(uicore, &fval,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned value", "[=getdesign_name=]_getalt_DMb___ulonglong");
...
int [=getdesign_name=]_getalt_DMb___fdouble(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    rt = [=getdesign_name=]_read0_DMw(uicore, &fval,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned value", "[=getdesign_name=]_getalt_DMb___fdouble");
    val |= CHESS_MASKLL(fval, 32) << 0;
    // component 1 : 32 bits at 32
    addr -= 4;
    rt = [=getdesign_name=]_read0_DMw(uicore, &fval,1, chess_[=getdesign_name=]_DMb_si, addr);
...
int [=getdesign_name=]_getalt_DMb___flongdouble(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    rt = [=getdesign_name=]_read0_DMw(uicore, &fval,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned value", "[=getdesign_name=]_getalt_DMb___flongdouble");
    val |= CHESS_MASKLL(fval, 32) << 0;
    // component 1 : 32 bits at 32
    addr -= 4;
    rt = [=getdesign_name=]_read0_DMw(uicore, &fval,1, chess_[=getdesign_name=]_DMb_si, addr);
...
int [=getdesign_name=]_get_DMb___PPMbvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(PMb) * value", "[=getdesign_name=]_get_DMb___PPMbvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___PPMbvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___PPMbvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(PMb) * value", "[=getdesign_name=]_put_DMb___PPMbvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___PPMbvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(PMb) * value", "[=getdesign_name=]_getalt_DMb___PPMbvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___PPMbvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___PPMbvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(PMb) * value", "[=getdesign_name=]_putalt_DMb___PPMbvoid");
    return chkapi_OK;
}
...
// ! no suitable stack memory for type `uint5nz'

// ! no suitable stack memory for type `uint5nz'

// ! no suitable stack memory for type `uint6_1_31'

// ! no suitable stack memory for type `uint6_1_31'

// ! no suitable stack memory for type `uint7s4'

// ! no suitable stack memory for type `uint7s4'

// ! no suitable stack memory for type `uint8'

// ! no suitable stack memory for type `uint8'

// ! no suitable stack memory for type `uint8s4'

// ! no suitable stack memory for type `uint8s4'

// ! no suitable stack memory for type `uint10nz4'

// ! no suitable stack memory for type `uint10nz4'

// ! no suitable stack memory for type `uint12'
...
// ! no suitable stack memory for type `int3'
...
// ! no suitable stack memory for type `int6n'

// ! no suitable stack memory for type `int6n'

// ! no suitable stack memory for type `int6p'

// ! no suitable stack memory for type `int6p'

// ! no suitable stack memory for type `int6'

// ! no suitable stack memory for type `int6'

// ! no suitable stack memory for type `int9s2'

// ! no suitable stack memory for type `int9s2'

// ! no suitable stack memory for type `int10ns16'

// ! no suitable stack memory for type `int10ns16'

// ! no suitable stack memory for type `int10ps16'

// ! no suitable stack memory for type `int10ps16'

// ! no suitable stack memory for type `int12'

// ! no suitable stack memory for type `int12'

// ! no suitable stack memory for type `int12s2'

// ! no suitable stack memory for type `int12s2'

// ! no suitable stack memory for type `int13s2'
...
// ! no suitable stack memory for type `int20'

// ! no suitable stack memory for type `int20'

int [=getdesign_name=]_get_DMb_int20p(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    addr -= 4;
    int rt = [=getdesign_name=]_read0_pad12_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int20p value", "[=getdesign_name=]_get_DMb_int20p");
    return chkapi_OK;
}

int [=getdesign_name=]_put_DMb_int20p(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    unsigned long long pval = 0;
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb_int20p");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_pad12_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put int20p value", "[=getdesign_name=]_put_DMb_int20p");
    return chkapi_OK;
}

int [=getdesign_name=]_getalt_DMb_int20p(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    addr -= 4;
    int rt = [=getdesign_name=]_read0_pad12_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int20p value", "[=getdesign_name=]_getalt_DMb_int20p");
    return chkapi_OK;
}

int [=getdesign_name=]_putalt_DMb_int20p(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    unsigned long long pval = 0;
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb_int20p");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_pad12_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put int20p value", "[=getdesign_name=]_putalt_DMb_int20p");
    return chkapi_OK;
}

// ! no suitable stack memory for type `int21s2'
...
// ! no suitable stack memory for type `v4uint1'

// ! no suitable stack memory for type `v4uint1'

// ! no suitable stack memory for type `v4uint8'

// ! no suitable stack memory for type `v4uint8'

int [=getdesign_name=]_get_DMb_v2short(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    addr -= 4;
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get v2short value", "[=getdesign_name=]_get_DMb_v2short");
    return chkapi_OK;
}

int [=getdesign_name=]_put_DMb_v2short(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    unsigned long long pval = 0;
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb_v2short");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put v2short value", "[=getdesign_name=]_put_DMb_v2short");
    return chkapi_OK;
}

int [=getdesign_name=]_getalt_DMb_v2short(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    addr -= 4;
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get v2short value", "[=getdesign_name=]_getalt_DMb_v2short");
    return chkapi_OK;
}

int [=getdesign_name=]_putalt_DMb_v2short(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    unsigned long long pval = 0;
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb_v2short");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put v2short value", "[=getdesign_name=]_putalt_DMb_v2short");
    return chkapi_OK;
}
...
static Ctp_access_fn acfns[] = {
    ...
    { checkers_[=getdesign_name=]_PMb_si, "uint8", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
...
#ifdef checkers_[=getdesign_name=]_DMb_si
    { checkers_[=getdesign_name=]_DMb_si, "bool", [=getdesign_name=]_read1_record0, [=getdesign_name=]_write1_record0 },
    ...
    { checkers_[=getdesign_name=]_DMb_si, "__slonglong", [=getdesign_name=]_read1_record1, [=getdesign_name=]_write1_record1 },
    { checkers_[=getdesign_name=]_DMb_si, "__ulonglong", [=getdesign_name=]_read1_record1, [=getdesign_name=]_write1_record1 },
    { checkers_[=getdesign_name=]_DMb_si, "__ffloat", [=getdesign_name=]_read0_DMw, [=getdesign_name=]_write0_DMw },
    { checkers_[=getdesign_name=]_DMb_si, "__fdouble", [=getdesign_name=]_read1_record1, [=getdesign_name=]_write1_record1 },
    { checkers_[=getdesign_name=]_DMb_si, "__flongdouble", [=getdesign_name=]_read1_record1, [=getdesign_name=]_write1_record1 },
    ...
    { checkers_[=getdesign_name=]_DMb_si, "int20p", [=getdesign_name=]_read0_pad12_DMw, [=getdesign_name=]_write0_pad12_DMw },
    { checkers_[=getdesign_name=]_DMb_si, "v2short", [=getdesign_name=]_read0_DMw, [=getdesign_name=]_write0_DMw },
...
#ifdef checkers_[=getdesign_name=]_DMw_si
    { checkers_[=getdesign_name=]_DMw_si, "bool", [=getdesign_name=]_read1_record2, [=getdesign_name=]_write1_record2 },
    ...
    { checkers_[=getdesign_name=]_DMw_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_DMw_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_DMw_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_DMw_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_DMw_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    ...
    { checkers_[=getdesign_name=]_DMw_si, "int20p", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
    { checkers_[=getdesign_name=]_DMw_si, "v2short", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_DMw_si
#ifdef checkers_[=getdesign_name=]_DMb_stat_si
    { checkers_[=getdesign_name=]_DMb_stat_si, "bool", [=getdesign_name=]_read1_record4, [=getdesign_name=]_write1_record4 },
    ...
    { checkers_[=getdesign_name=]_DMb_stat_si, "__slonglong", [=getdesign_name=]_read1_record5, [=getdesign_name=]_write1_record5 },
    { checkers_[=getdesign_name=]_DMb_stat_si, "__ulonglong", [=getdesign_name=]_read1_record5, [=getdesign_name=]_write1_record5 },
    { checkers_[=getdesign_name=]_DMb_stat_si, "__ffloat", [=getdesign_name=]_read0_DMw_stat, [=getdesign_name=]_write0_DMw_stat },
    { checkers_[=getdesign_name=]_DMb_stat_si, "__fdouble", [=getdesign_name=]_read1_record5, [=getdesign_name=]_write1_record5 },
    { checkers_[=getdesign_name=]_DMb_stat_si, "__flongdouble", [=getdesign_name=]_read1_record5, [=getdesign_name=]_write1_record5 },
    ...
    { checkers_[=getdesign_name=]_DMb_stat_si, "int20p", [=getdesign_name=]_read0_pad12_DMw_stat, [=getdesign_name=]_write0_pad12_DMw_stat },
    { checkers_[=getdesign_name=]_DMb_stat_si, "v2short", [=getdesign_name=]_read0_DMw_stat, [=getdesign_name=]_write0_DMw_stat },
...
#ifdef checkers_[=getdesign_name=]_DMw_stat_si
    { checkers_[=getdesign_name=]_DMw_stat_si, "bool", [=getdesign_name=]_read1_record2, [=getdesign_name=]_write1_record2 },
    ...
    { checkers_[=getdesign_name=]_DMw_stat_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_DMw_stat_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    ...
    { checkers_[=getdesign_name=]_DMw_stat_si, "int20p", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
    { checkers_[=getdesign_name=]_DMw_stat_si, "v2short", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_DMw_stat_si
#ifdef checkers_[=getdesign_name=]_R_si
    { checkers_[=getdesign_name=]_R_si, "bool", [=getdesign_name=]_read1_record2, [=getdesign_name=]_write1_record2 },
    ...
    { checkers_[=getdesign_name=]_R_si, "__slonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_R_si, "__ulonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_R_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R_si, "__fdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_R_si, "__flongdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    ...
    { checkers_[=getdesign_name=]_R_si, "int20p", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
    { checkers_[=getdesign_name=]_R_si, "v2short", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_R_si
#ifdef checkers_[=getdesign_name=]_R8_15_si
    { checkers_[=getdesign_name=]_R8_15_si, "bool", [=getdesign_name=]_read1_record2, [=getdesign_name=]_write1_record2 },
    { checkers_[=getdesign_name=]_R8_15_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__slonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_R8_15_si, "__ulonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_R8_15_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__fdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_R8_15_si, "__flongdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_R8_15_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__PPMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R8_15_si, "int20p", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
    { checkers_[=getdesign_name=]_R8_15_si, "v2short", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_R8_15_si
#ifdef checkers_[=getdesign_name=]_LR_si
    { checkers_[=getdesign_name=]_LR_si, "bool", [=getdesign_name=]_read1_record2, [=getdesign_name=]_write1_record2 },
    ...
    { checkers_[=getdesign_name=]_LR_si, "__slonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_LR_si, "__ulonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_LR_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LR_si, "__fdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_LR_si, "__flongdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    ...
    { checkers_[=getdesign_name=]_LR_si, "int20p", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
    { checkers_[=getdesign_name=]_LR_si, "v2short", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_LR_si
#ifdef checkers_[=getdesign_name=]_SP_si
    { checkers_[=getdesign_name=]_SP_si, "bool", [=getdesign_name=]_read1_record2, [=getdesign_name=]_write1_record2 },
    ...
    { checkers_[=getdesign_name=]_SP_si, "__slonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_SP_si, "__ulonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_SP_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_SP_si, "__fdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_SP_si, "__flongdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    ...
    { checkers_[=getdesign_name=]_SP_si, "int20p", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
    { checkers_[=getdesign_name=]_SP_si, "v2short", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
#endif //checkers_[=getdesign_name=]_SP_si
#ifdef checkers_[=getdesign_name=]_PC_si
    { checkers_[=getdesign_name=]_PC_si, "bool", [=getdesign_name=]_read1_record2, [=getdesign_name=]_write1_record2 },
    ...
    { checkers_[=getdesign_name=]_PC_si, "__slonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_PC_si, "__ulonglong", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_PC_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_PC_si, "__fdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    { checkers_[=getdesign_name=]_PC_si, "__flongdouble", [=getdesign_name=]_read1_record6, [=getdesign_name=]_write1_record6 },
    ...
    { checkers_[=getdesign_name=]_PC_si, "int20p", [=getdesign_name=]_read0_pad12, [=getdesign_name=]_write0_pad12 },
    { checkers_[=getdesign_name=]_PC_si, "v2short", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
...
int [=getdesign_name=]_chess_assert_bool(Checkers_uicore* uicore, int& oval)
{
    ...
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read1_record2(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_assert___cchar(Checkers_uicore* uicore, int& oval)
{
    ...
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_assert___slonglong(Checkers_uicore* uicore, int& oval)
{
    ...
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // component 1 : 32 bits at 32
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(11));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_assert___PPMbvoid(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___PPMbvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_assert_int20p(Checkers_uicore* uicore, int& oval)
{
    long long val[1] = {0};
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0_pad12(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert_int20p");
    val[0] |= CHESS_MASKLL(fval[0], 20) << 0;
    val[0] = CHESS_EXTENDLL(val[0],20);
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}

int [=getdesign_name=]_chess_assert_v2short(Checkers_uicore* uicore, int& oval)
{
    long long val[1] = {0};
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert_v2short");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    val[0] = CHESS_EXTENDLL(val[0],32);
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
static Chess_assert_fn cafns[] = {
    ...
    { "int20p", [=getdesign_name=]_chess_assert_int20p },
    { "v2short", [=getdesign_name=]_chess_assert_v2short },
    { 0, 0 } /* sentinel */
};
...
int [=getdesign_name=]_chess_report___PPMbvoid(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___PPMbvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    os << "chess_report(void*):";
    chess_report_hex(32, (unsigned long long)val[0], os);
    os << " //";
...
int [=getdesign_name=]_chess_report_int20p(Checkers_uicore* uicore, std::ostream& os)
{
    long long val[1] = {0};
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0_pad12(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report_int20p");
    val[0] |= CHESS_MASKLL(fval[0], 20) << 0;
    val[0] = CHESS_EXTENDLL(val[0],20);
    os << "chess_report(tzscale_primitive::int20p):";
    chess_report_hex(20, val[0], os);
    os << " //";
    chess_report_cycle_count(uicore, os);
    chess_report_signed(val[0], os);
    os << std::endl;
...
int [=getdesign_name=]_chess_report_v2short(Checkers_uicore* uicore, std::ostream& os)
{
    long long val[1] = {0};
    int rt;
    long long fval[1] = {0};
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report_v2short");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    val[0] = CHESS_EXTENDLL(val[0],32);
    os << "chess_report(v2short):";
    for (int i = 0; i < 2; i++) chess_report_hex(16, CHESS_EXTENDLL(val[0] >> (i*16), 16), os);
    os << " //";
    chess_report_cycle_count(uicore, os);
    for (int i = 0; i < 2; i++) chess_report_signed(CHESS_EXTENDLL(val[0] >> (i*16), 16), os);
    os << std::endl;
    return chkapi_OK;
}
...
static Chess_report_fn crfns[] = {
    ...
    { "int20p", [=getdesign_name=]_chess_report_int20p },
    { "v2short", [=getdesign_name=]_chess_report_v2short },
    { 0, 0 } /* sentinel */
};
...
int [=getdesign_name=]_chess_return_value___cchar(Checkers_uicore* uicore, DataType& ovbit)
{
    DataType vbit(8, 1, 0);
    int rt = chkapi_OK;
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(101), at_addr), vbit);
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_return_value___slonglong(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(101), at_addr), vbit_component0);
    if (rt != chkapi_OK)
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(111), at_addr), vbit_component1);
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_chess_return_value___PPMbvoid(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(101), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___PPMbvoid");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value_int20p(Checkers_uicore* uicore, DataType& ovbit)
{
    DataType vbit(20, 1, 0);
    int rt = chkapi_OK;
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(101), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value_int20p");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}

int [=getdesign_name=]_chess_return_value_v2short(Checkers_uicore* uicore, DataType& ovbit)
{
    DataType vbit(32, 1, 0);
    int rt = chkapi_OK;
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(101), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value_v2short");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
static Chess_return_value_fn cvfns[] = {
    ...
    { "int20p", [=getdesign_name=]_chess_return_value_int20p },
    { "v2short", [=getdesign_name=]_chess_return_value_v2short },
    { 0, 0 } /* sentinel */
};
...
int [=getdesign_name=]_chess_cycle_count(Checkers_uicore* uicore, long long val)
{
    ...
    rt = [=getdesign_name=]_write0(uicore, &fval,1, chess_[=getdesign_name=]_R_si, AddressType(10));
    if (rt != chkapi_OK)
    ...
    rt = [=getdesign_name=]_write0(uicore, &fval,1, chess_[=getdesign_name=]_R_si, AddressType(11));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_write_main_argc_argv(Checkers_uicore* uicore, long long argc, AddressType argv)
{
    ...
    val = argv;
    fval = CHESS_MASKLL(val >> 0,32);
    rt = [=getdesign_name=]_write0(uicore, &fval,1, chess_[=getdesign_name=]_R_si, AddressType(12));
    if (rt != chkapi_OK)
...
int [=getdesign_name=]_read_word_ptr_PMb(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_word_ptr_PMb");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_PMb_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tzscale_read_word_ptr_PMb");
        if (lsb_first)
...
int [=getdesign_name=]_write_word_ptr_PMb(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_word_ptr_PMb");
    ptr = CHESS_MASKLL(ptr,32);
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tzscale_write_word_ptr_PMb");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_PMb(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_ptr_PMb");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < size*nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_PMb_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tzscale_read_ptr_PMb");
...
int [=getdesign_name=]_write_ptr_PMb(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_ptr_PMb");
    ptr = CHESS_MASKLL(ptr,32);
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_PMb_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tzscale_write_ptr_PMb");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_PM(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    for (int i = 0; i < nmemb; i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tzscale_read_word_ptr_PM");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_PM(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tzscale_write_word_ptr_PM");
        ptr += 4;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_PM(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (int i = 0; i < size*nmemb; i++) {
        ...
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_PM_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tzscale_read_ptr_PM");
        dta.push_back(val & 0xff);
        ptr += 4;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_PM(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_PM_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tzscale_write_ptr_PM");
        ptr += 4;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMb(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    for (int i = 0; i < nmemb; i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tzscale_read_word_ptr_DMb");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMb(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tzscale_write_word_ptr_DMb");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMb(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (int i = 0; i < size*nmemb; i++) {
        ...
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tzscale_read_ptr_DMb");
        dta.push_back(val & 0xff);
        ptr += 1;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMb(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tzscale_write_ptr_DMb");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMh(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    for (int i = 0; i < nmemb; i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tzscale_read_word_ptr_DMh");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMh(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tzscale_write_word_ptr_DMh");
        ptr += 2;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMh(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (int i = 0; i < size*nmemb; i++) {
        ...
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMh_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tzscale_read_ptr_DMh");
        dta.push_back(val & 0xff);
        ptr += 2;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMh(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMh_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tzscale_write_ptr_DMh");
        ptr += 2;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMw(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    for (int i = 0; i < nmemb; i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tzscale_read_word_ptr_DMw");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMw(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tzscale_write_word_ptr_DMw");
        ptr += 4;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMw(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (int i = 0; i < size*nmemb; i++) {
        ...
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMw_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tzscale_read_ptr_DMw");
        dta.push_back(val & 0xff);
        ptr += 4;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMw(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMw_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tzscale_write_ptr_DMw");
        ptr += 4;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMb_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    for (int i = 0; i < nmemb; i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tzscale_read_word_ptr_DMb_stat");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMb_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tzscale_write_word_ptr_DMb_stat");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMb_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (int i = 0; i < size*nmemb; i++) {
        ...
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tzscale_read_ptr_DMb_stat");
        dta.push_back(val & 0xff);
        ptr += 1;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMb_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tzscale_write_ptr_DMb_stat");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMh_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    for (int i = 0; i < nmemb; i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tzscale_read_word_ptr_DMh_stat");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMh_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tzscale_write_word_ptr_DMh_stat");
        ptr += 2;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMh_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (int i = 0; i < size*nmemb; i++) {
        ...
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMh_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tzscale_read_ptr_DMh_stat");
        dta.push_back(val & 0xff);
        ptr += 2;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMh_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMh_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tzscale_write_ptr_DMh_stat");
        ptr += 2;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMw_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    for (int i = 0; i < nmemb; i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tzscale_read_word_ptr_DMw_stat");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMw_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tzscale_write_word_ptr_DMw_stat");
        ptr += 4;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMw_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (int i = 0; i < size*nmemb; i++) {
        ...
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMw_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tzscale_read_ptr_DMw_stat");
        dta.push_back(val & 0xff);
        ptr += 4;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMw_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMw_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tzscale_write_ptr_DMw_stat");
        ptr += 4;
    }
    return chkapi_OK;
}
