...
// module reg_CB : reg_CB
module reg_CB
  // synopsys translate_off
  #(parameter reg_log = 1'b1,
    parameter reg_log_name = "CB"
  )
  // synopsys translate_on
  ( input            clock,
    input      [2:0] bin_selector_E1,
    input            __pm_read_w_SR_el1_in, // uint1
    input            cbw_in, // uint1
    input            dm_read_rec2_in, // uint1
    input            wbus_rec9_in, // uint1
    output reg       __pm_write_r_SR_el1_out, // uint1
    output reg       cbr_out, // uint1
    output reg       dm_write_rec2_out, // uint1
    output reg       wbus_rec2_out // uint1
  );
  ...
  begin : p_read_reg_CB
    ...
    wbus_rec2_out = reg_val;

    // (dm_write_rd_SR_E1_t1)
    // [load_store.n:57][load_store.n:99](tmicro.n:132)
    dm_write_rec2_out = reg_val;

    // (__pm_write_r_SR_rd_SR_E1_t1)
    // [load_store.n:130](tmicro.n:132)
    __pm_write_r_SR_el1_out = reg_val;

  end

  always @ (*)
  begin : p_write_combin_reg_CB
    ...
    case (bin_selector_E1)
      3'b001 : // (CB_wr_cbw_E1)
      begin
        // [alu.n:68][alu.n:69][alu.n:70][alu.n:71]
        reg_write_enab = 1'b1;
        reg_val_next = cbw_in;
      end
      3'b010 : // (SR_wr_wbus_E1_t1)
      begin
        // [move.n:48][move.n:55][move.n:62][move.n:106][control.n:238][dma.n:70](tmicro.n:132)
        reg_write_enab = 1'b1;
        reg_val_next = wbus_rec9_in;
      end
      3'b011 : // (SR_wr_dm_read_E1_t1)
      begin
        // [load_store.n:51][load_store.n:93](tmicro.n:132)
        reg_write_enab = 1'b1;
        reg_val_next = dm_read_rec2_in;
      end
      3'b100 : // (SR_wr___pm_read_w_SR_E1_t1)
      begin
        // [load_store.n:116](tmicro.n:132)
        reg_write_enab = 1'b1;
        reg_val_next = __pm_read_w_SR_el1_in;
      end
      default :
        ; // null
    endcase
