...
extern size_t fwrite(const void chess_storage(DM)* ptr, size_t size, size_t nmemb, FILE* stream) property(loop_free);

extern size_t fread(void chess_storage(DM)* ptr, size_t size, size_t nmemb, FILE* stream) property(loop_free);
...
extern size_t fwrite_word(const void chess_storage(DM)* ptr, size_t size, size_t nword, int lsb_first, FILE* stream) property(loop_free);

extern size_t fread_word(void chess_storage(DM)* ptr, size_t size, size_t nword, int lsb_first, FILE* stream) property(loop_free);
