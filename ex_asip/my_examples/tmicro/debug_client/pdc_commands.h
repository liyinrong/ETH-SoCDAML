...
public:
    ...
    typedef Checkers_debugger::Trace_entry Trace_entry;
 ...
 // hardware breakpoints/watchpoints :
    int watch_supported(const Watchpoint_settings*) const;
 ...
 // blocked based read access of storages :
    ...
    DataType received_next_reg(string)         { return received_next(); }
 ...
 // vectorised access to registers and memories :
    unsigned vector_size(string name) { return 0; }
...
// tracing:
    void get_trace(std::vector<Trace_entry>& buf);
    void config_trace(long long value);
...
private:
 ...
 // current value of ocd_address_register, incremented on each st/ld :
    ...
    void execute_ldst_instr(int ldst_instr) {
