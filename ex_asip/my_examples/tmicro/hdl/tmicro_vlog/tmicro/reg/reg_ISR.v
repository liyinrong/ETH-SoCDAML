...
// module reg_ISR : reg_ISR
module reg_ISR
  // synopsys translate_off
  #(parameter reg_log = 1'b1,
    parameter reg_log_name = "ISR"
  )
  // synopsys translate_on
  ( input                    clock,
    input              [1:0] bin_selector_E1,
    input      signed [15:0] __pm_read_w_ISR_in, // word
    input      signed [15:0] dm_read_dp_in, // word
    input      signed [15:0] wbus_in, // word
    output reg signed [15:0] __pm_write_r_ISR_out, // word
  ...
  always @ (*)
  begin : p_read_reg_ISR

    // __pm_write_r_ISR_out = 0;
    // dm_write_out = 0;
    // wbus_out = 0;
    ...
    // (__pm_write_r_ISR_rd_ISR_E1)
    // [load_store.n:130](tmicro.n:135)
    __pm_write_r_ISR_out = reg_val;

  end

  always @ (*)
  begin : p_write_combin_reg_ISR
    ...
    case (bin_selector_E1)
      2'b01 : // (ISR_wr_wbus_E1)
      begin
        // [move.n:48][move.n:55][move.n:62][move.n:106][control.n:225][dma.n:70](tmicro.n:135)
        reg_write_enab = 1'b1;
        reg_val_next = wbus_in;
      end
      2'b10 : // (ISR_wr_dm_read_E1)
      begin
        // [load_store.n:51][load_store.n:93](tmicro.n:135)
        reg_write_enab = 1'b1;
        reg_val_next = dm_read_dp_in;
      end
      2'b11 : // (ISR_wr___pm_read_w_ISR_E1)
      begin
        // [load_store.n:116](tmicro.n:135)
        reg_write_enab = 1'b1;
        reg_val_next = __pm_read_w_ISR_in;
      end
      default :
        ; // null
    endcase
