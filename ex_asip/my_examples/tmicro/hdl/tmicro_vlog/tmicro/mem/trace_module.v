...
// module trace_module : trace_module
...
module trace_module
  ...
  reg_trace_module__traceMem
  // synopsys translate_off
  #(reg_log, "trace_module__traceMem")
  // synopsys translate_on
  inst_reg_trace_module__traceMem(
      .clock(clock),
      .traceMem_trnMem_r_re_in(traceMem_trnMem_r_re),
      .traceMem_trnMem_w_we_in(traceMem_trnMem_w_we),
      .traceMem_trnMem_r_r_a_in(traceMem_trnMem_r_r_a),
      .traceMem_trnMem_w_w_a_in(traceMem_trnMem_w_w_a),
      .trnMem_w_in(trnMem_w),
      .trnMem_r_out(trnMem_r));
